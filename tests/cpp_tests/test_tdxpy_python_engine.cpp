...
protected:
    ...
    "python_config": {
        "python_home": ")" << pythonHome << R"(",
        "python_venv_home": ")" << pythonVenv << R"(",
        "python_executable": ")" << pythonHome << "/python.exe" << R"(",
        "python_formulas_home": ")" << pythonFormulas << R"(",
        "enable_debug": true,
        "search_paths": [
            ")" << pythonHome << R"(",
            ")" << pythonHome << "/Lib" << R"(",
